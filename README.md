...
|---|---|---|---|---|
|**2022-11-29**|**Extended Polarimetric Observations of Chaff using the WSR-88D Weather Radar Network**|James M. Kurdzo et.al.|[2211.16417v1](http://arxiv.org/abs/2211.16417v1)|null|
|**2022-11-29**|**MmWave Mapping and SLAM for 5G and Beyond**|Yu Ge et.al.|[2211.16024v1](http://arxiv.org/abs/2211.16024v1)|null|
|**2022-11-29**|**Shadow-Oriented Tracking Method for Multi-Target Tracking in Video-SAR**|Xiaochuan Ni et.al.|[2211.15995v1](http://arxiv.org/abs/2211.15995v1)|null|
|**2022-11-29**|**How Important are Good Method Names in Neural Code Generation? A Model Robustness Perspective**|Guang Yang et.al.|[2211.15844v1](http://arxiv.org/abs/2211.15844v1)|null|
...
|**2022-11-19**|**ISAC Meets SWIPT: Multi-functional Wireless Systems Integrating Sensing, Communication, and Powering**|Yilong Chen et.al.|[2211.10605v1](http://arxiv.org/abs/2211.10605v1)|null|
...
|**2022-11-18**|**Beurling-Selberg Extremization for Dual-Blind Deconvolution Recovery in Joint Radar-Communications**|Jonathan Monsalve et.al.|[2211.09253v2](http://arxiv.org/abs/2211.09253v2)|null|
...
|**2022-11-14**|**MIBINET: Real-time Proctoring of Cardiovascular Inter-Beat-Intervals using a Multifaceted CNN from mm-Wave Ballistocardiography Signal**|Rafid Umayer Murshed et.al.|[2211.07776v1](http://arxiv.org/abs/2211.07776v1)|null|
...
|**2022-11-09**|**MAGAL Constellation -- Using a Small Satellite Altimeter Constellation to Monitor Local and Regional Ocean and Inland Water Variations**|André G. C. Guerra et.al.|[2211.05017v1](http://arxiv.org/abs/2211.05017v1)|null|
|**2022-11-08**|**Millimeter-Wave Radar Beamforming with Spatial Path Index Modulation Communications**|Ahmet M. Elbir et.al.|[2211.04540v1](http://arxiv.org/abs/2211.04540v1)|null|
|**2022-11-08**|**Physics-informed inference of aerial animal movements from weather radar data**|Fiona Lippert et.al.|[2211.04539v1](http://arxiv.org/abs/2211.04539v1)|null|
...
|**2022-11-13**|**Intelligent Surface Enabled Sensing-Assisted Communication**|Kaitao Meng et.al.|[2211.04200v2](http://arxiv.org/abs/2211.04200v2)|null|
...
|**2022-11-05**|**Deep Learning for Rapid Landslide Detection using Synthetic Aperture Radar (SAR) Datacubes**|Vanessa Boehm et.al.|[2211.02869v1](http://arxiv.org/abs/2211.02869v1)|**[link](https://github.com/iprapas/landslide-sar-unet)**|
